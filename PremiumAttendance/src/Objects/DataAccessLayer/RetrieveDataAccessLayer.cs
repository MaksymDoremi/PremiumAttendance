...
namespace PremiumAttendance.objects
{
    public partial class DataAccessLayer
    {
        ...
        /// <summary>
        /// Reads notifications for current <see cref="Employee"/>
        /// </summary>
        ...
        /// </summary>
        /// <param name="currentEmployeeLogin"></param>
        /// <returns><see cref="System.Data.DataTable"/> of employee statuses</returns>
        ...
        /// <summary>
        /// Returns <see cref="DataTable"/> of employees who are momentally at work in format Name, Surname, Photo
        /// </summary>
        /// <param name="currentEmployeeLogin"></param>
        /// <returns><see cref="DataTable"/> of employees who are at work</returns>
        ...
        public Dictionary<string, int> GetHoursDays(string employeeLogin)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, DatabaseConnection.GetConnection()))
                {
                    ...
                    return new Dictionary<string, int>() { { "days", (int)reader[2] }, { "hours", (int)reader[1] } };
                }
            }
            catch (Exception ex)
            {

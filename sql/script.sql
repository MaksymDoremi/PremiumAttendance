...
select * from Attendance where Employee_ID = 3;

DECLARE @StartDate datetime = '2024-03-01'; -- Replace with your start date
DECLARE @EndDate datetime = '2024-03-31'; -- Replace with your end date
